...
class StoreBookingRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'recurrence.in' => 'Invalid recurrence type selected.',
            'recurrence_end_date.after_or_equal' => 'Recurrence end date must be on or after the meeting date.',
            'recurrence_end_date.required_with' => 'Recurrence end date is required when recurrence is selected.',
        ];
    }
